...
public class DefaultHacimpexauditService implements HacimpexauditService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultHacimpexauditService.class);
	...
	{
		return DefaultHacimpexauditService.class.getResourceAsStream("/hacimpexaudit/sap-hybris-platform.png");
	}
